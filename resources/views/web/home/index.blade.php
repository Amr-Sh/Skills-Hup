...
@section('main')
    ...
    <div id="home" class="hero-area">
        ...
        <div class="bg-image bg-parallax overlay" style="background-image:url(
            {{asset('web/img/home-background.jpg')}})"></div>
        <!-- /Backgound Image -->
        ...
        <div class="home-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="white-text">@lang('web.title')</h1>
                        <p class="lead white-text">@lang('web.subtitle')</p>
                        <a class="main-button icon-button" href="#">@lang('web.start')!</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="section-header text-center">
                    <h2>@lang('web.popular')</h2>
                    <p class="lead">@lang('web.popularsub')</p>
                </div>
            </div>
            <!-- /row -->
            ...
            <div class="row">
                <div class="center-btn">
                    <a class="main-button icon-button" href="#">@lang('web.more')</a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    ...
                    <p class="lead white-text">@lang('web.keep')</p>
                    <a class="main-button icon-button" href=" {{url('contact')}} ">@lang('web.contactnow')</a>
                </div>
