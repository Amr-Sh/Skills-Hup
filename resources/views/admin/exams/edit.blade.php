  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit {{$exam->name('en')}} </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-12 pb-3">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <label >Descreption(en)</label>
                        <textarea  class="form-control" rows="5" name="desc_en"  > {{$exam->desc('en')}} </textarea>
                    </div>
                    <div class="form-group">
                        <label >Descreption(ar)</label>
                        <textarea  class="form-control" rows="5" name="desc_ar"  > {{$exam->desc('ar')}} </textarea>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="skill_id">
                                    @foreach($skills as $skill)
                                        <option value="{{$skill->id}}" @if($exam->skill->id == $skill->id) selected  @endif>
                                            {{$skill->name('en')}}
                                        </option>
                                     @endforeach
                                </select>
